...
class CNN(object):
    def __init__(self):
        ...
        # 第1层卷积，卷积核大小为3*3，32个，28*28为待训练图片的大小，在第一层中传递尺寸后，后面会自动推理尺寸
        # 这里使用 2D 卷积层，对图像空间的卷积
        model.add(layers.Conv2D(32, (3, 3), activation='relu', input_shape=(28, 28, 1)))
        model.add(layers.MaxPooling2D((2, 2)))  # 2D 空间最大池化
...
class Train:
    ...
    def train(self):
        # 模型保存路径
        check_path = 'D:/Learn_Files/TensorFlowL/Mnist/model/cp-{epoch:04d}.ckpt'
